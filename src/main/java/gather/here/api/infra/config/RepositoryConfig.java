...
import gather.here.api.infra.persistence.jpa.*;
...
public class RepositoryConfig {
    ...
    @Bean
    public RoomCustomRepository roomCustomRepository(JPAQueryFactory jpaQueryFactory){
        return new RoomCustomRepositoryImpl(jpaQueryFactory);
    }
